       ...
       const createScene = () => {
        ...
        //    skySphere.material.sunPosition = new BABYLON.Vector3(0, 5, -50);
           ...
           scene.activeCamera.onViewMatrixChangedObservable.add(() => {
               const distance = BABYLON.Vector3.Distance(scene.activeCamera.position, sphere.position);
           ...
           BABYLON.SceneLoader.ImportMesh("", "./models/capsule/", "Grass_type_1.glb", scene, (meshes) => {
               ...
               for (let index = 0; index < bladeCount - 1; index++) {
                   ...
                   instance1.scaling.set(.04, .04, .04);
                   instance1.rotate(BABYLON.Axis.Y, Math.random() * Math.PI * 2, BABYLON.Space.WORLD);
           ...
           BABYLON.SceneLoader.ImportMesh("", "./models/capsule/", "Grass_type_2.glb", scene, (meshes) => {
               ...
               for (let index = 0; index < bladeCount - 1; index++) {
                   ...
                   instance2.scaling.set(.05, .05, .05);
                   instance2.rotate(BABYLON.Axis.Y, Math.random() * Math.PI * 2, BABYLON.Space.WORLD);
           ...
           BABYLON.SceneLoader.ImportMesh("", "./models/capsule/", "Fern.glb", scene, (meshes) => {
               ...
               for (let index = 0; index < bladeCount - 1; index++) {
                   ...
                   instance3.scaling.set(.04, .04, .04);
                   instance3.rotate(BABYLON.Axis.Y, Math.random() * Math.PI * 2, BABYLON.Space.WORLD);
