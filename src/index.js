      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route
            ...
            element={<ForgetPasswordFirst />}
          />
          <Route path="/ForgetPasswordCode" element={<ForgetPasswordCode />} />
          <Route path="/CreatePassword" element={<CreatePassword />} />
          <Route
            path="/LegacyBoxSettingFULL"
            element={<LegacyBoxSettingFULL />}
          />
          ...
          <Route
            path="/CustomDesignLegacyRoom"
            element={<CustomDesignLegacyRoom />}
          />
          <Route path="/Support" element={<Support />} />
          <Route
            path="/LegacyBoxFriendData"
            element={<LegacyBoxFriendData />}
          />
          <Route
            path="/CustomTombstoneDesign"
            element={<CustomTombstoneDesign />}
          />
          <Route path="/EmailConfirmation" element={<EmailConfirmation />} />
          <Route path="/Profile" element={<Profile />} />
          <Route
            path="/ProfileNetworkConnection"
            element={<ProfileNetworkConnection />}
          />
